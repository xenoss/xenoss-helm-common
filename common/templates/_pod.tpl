{{- define "pod.content" -}}
          ...
          envFrom:
            ...
            {{- end }}
          {{- end }}
          {{- if .Values.global.containerPorts .Values.global.extraContainerPorts }}
          {{- $containerPorts := concat (list) .Values.global.containerPorts .Values.global.extraContainerPorts }}
          ports:
